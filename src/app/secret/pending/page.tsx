...
export default function Page() {
    ...
    useEffect(() => {
        if (approveResult.called && !approveResult.loading && !approveResult.error) {
    ...
    return loading ? <LoadingScreen /> : pending?.bots.nodes?.length ? <Table>
        <TableCaption>Current pending bots</TableCaption>
        <TableHeader>
            <TableRow>
