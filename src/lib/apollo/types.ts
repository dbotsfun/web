...
export type AuthTokensObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["AuthTokensObject"] = ResolversParentTypes["AuthTokensObject"],
> = {
...
export type AuthUserInfoObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["AuthUserInfoObject"] = ResolversParentTypes["AuthUserInfoObject"],
> = {
...
export type AuthUserObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["AuthUserObject"] = ResolversParentTypes["AuthUserObject"],
> = {
	auth?: Resolver<
		ResolversTypes["AuthUserInfoObject"],
		ParentType,
		ContextType
	>;
...
export type BadgeObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["BadgeObject"] = ResolversParentTypes["BadgeObject"],
> = {
...
export type BotObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["BotObject"] = ResolversParentTypes["BotObject"],
> = {
	apiInformation?: Resolver<
		ResolversTypes["BotStatsObject"],
		ParentType,
		ContextType
	>;
	avatar?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
	...
	id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
	importedFrom?: Resolver<
		ResolversTypes["BotListSource"],
		ParentType,
		ContextType
	>;
	inviteLink?: Resolver<
	...
	owners?: Resolver<
		Array<ResolversTypes["UserObject"]>,
		ParentType,
		ContextType
	>;
	prefix?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
	reviews?: Resolver<
		ResolversTypes["ReviewsConnection"],
		ParentType,
		ContextType,
		Partial<BotObjectReviewsArgs>
	>;
...
export type BotObjectEdgeResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["BotObjectEdge"] = ResolversParentTypes["BotObjectEdge"],
> = {
...
export type BotStatsApplicationResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["BotStatsApplication"] = ResolversParentTypes["BotStatsApplication"],
> = {
	bot_public?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
	bot_require_code_grant?: Resolver<
	...
	id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
	install_params?: Resolver<
		ResolversTypes["BotStatsInstallParams"],
		ParentType,
		ContextType
	>;
	name?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
	privacy_policy_url?: Resolver<
...
export type BotStatsBotResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["BotStatsBot"] = ResolversParentTypes["BotStatsBot"],
> = {
	approximate_guild_count?: Resolver<
		Maybe<ResolversTypes["Int"]>,
		ParentType,
		ContextType
	>;
	avatar?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
	avatar_decoration?: Resolver<
		Maybe<ResolversTypes["String"]>,
		ParentType,
		ContextType
	>;
...
export type BotStatsInstallParamsResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["BotStatsInstallParams"] = ResolversParentTypes["BotStatsInstallParams"],
> = {
...
export type BotStatsObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["BotStatsObject"] = ResolversParentTypes["BotStatsObject"],
> = {
	application?: Resolver<
		ResolversTypes["BotStatsApplication"],
		ParentType,
		ContextType
	>;
...
export type BotsConnectionResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["BotsConnection"] = ResolversParentTypes["BotsConnection"],
> = {
	edges?: Resolver<
		Maybe<Array<ResolversTypes["BotObjectEdge"]>>,
		ParentType,
		ContextType
	>;
	nodes?: Resolver<
		Maybe<Array<ResolversTypes["BotObject"]>>,
		ParentType,
		ContextType
	>;
...
> = {
	approveBot?: Resolver<
		ResolversTypes["BotObject"],
		ParentType,
		ContextType,
		RequireFields<MutationApproveBotArgs, "id">
	>;
	createBot?: Resolver<
		ResolversTypes["BotObject"],
		ParentType,
		ContextType,
		RequireFields<MutationCreateBotArgs, "input">
	>;
	createReply?: Resolver<
		ResolversTypes["ReplyObject"],
		ParentType,
		ContextType,
		RequireFields<MutationCreateReplyArgs, "input">
	>;
	createReview?: Resolver<
		ResolversTypes["ReviewObject"],
		ParentType,
		ContextType,
		RequireFields<MutationCreateReviewArgs, "input">
	>;
	createTag?: Resolver<
		ResolversTypes["TagObject"],
		ParentType,
		ContextType,
	...
	editReply?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationEditReplyArgs, "input">
	>;
	editReview?: Resolver<
		ResolversTypes["ReviewObject"],
		ParentType,
		ContextType,
		RequireFields<MutationEditReviewArgs, "input">
	>;
	editUser?: Resolver<
	...
	importBot?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationImportBotArgs, "input">
	>;
	refreshToken?: Resolver<
		ResolversTypes["AuthTokensObject"],
		ParentType,
		ContextType
	>;
	rejectBot?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationRejectBotArgs, "input">
	>;
	...
	removeBot?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationRemoveBotArgs, "id">
	>;
	removeReply?: Resolver<
		ResolversTypes["ReplyObject"],
		ParentType,
		ContextType,
		RequireFields<MutationRemoveReplyArgs, "id">
	>;
	removeReview?: Resolver<
		ResolversTypes["ReviewObject"],
		ParentType,
		ContextType,
		RequireFields<MutationRemoveReviewArgs, "id">
	>;
	removeTag?: Resolver<
		ResolversTypes["TagObject"],
		ParentType,
		ContextType,
		RequireFields<MutationRemoveTagArgs, "name">
	>;
	renameTag?: Resolver<
		ResolversTypes["TagObject"],
		ParentType,
		ContextType,
		RequireFields<MutationRenameTagArgs, "input">
	>;
	resetAPIKey?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationResetApiKeyArgs, "input">
	>;
	...
	token?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationTokenArgs, "input">
	>;
	updateBot?: Resolver<
		ResolversTypes["BotObject"],
		ParentType,
		ContextType,
		RequireFields<MutationUpdateBotArgs, "input">
	>;
	updateBotInformation?: Resolver<
		ResolversTypes["BotObject"],
		ParentType,
		ContextType,
		RequireFields<MutationUpdateBotInformationArgs, "input">
	>;
	voteBot?: Resolver<
		ResolversTypes["VoteObject"],
		ParentType,
		ContextType,
		RequireFields<MutationVoteBotArgs, "id">
	>;
};
...
> = {
	bots?: Resolver<
		ResolversTypes["BotsConnection"],
		ParentType,
		ContextType,
		Partial<QueryBotsArgs>
	>;
	getApplicationInfo?: Resolver<
		ResolversTypes["BotStatsObject"],
		ParentType,
		ContextType,
		RequireFields<QueryGetApplicationInfoArgs, "id">
	>;
	getBot?: Resolver<
		ResolversTypes["BotObject"],
		ParentType,
		ContextType,
		RequireFields<QueryGetBotArgs, "id">
	>;
	getReply?: Resolver<
		ResolversTypes["ReplyObject"],
		ParentType,
		ContextType,
		RequireFields<QueryGetReplyArgs, "id">
	>;
	getReview?: Resolver<
		ResolversTypes["ReviewObject"],
		ParentType,
		ContextType,
		RequireFields<QueryGetReviewArgs, "id">
	>;
	getTag?: Resolver<
		ResolversTypes["TagObject"],
		ParentType,
		ContextType,
		RequireFields<QueryGetTagArgs, "name">
	>;
	...
	reviews?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<QueryReviewsArgs, "input">
	>;
	tags?: Resolver<
		ResolversTypes["TagsConnection"],
		ParentType,
		ContextType,
		Partial<QueryTagsArgs>
	>;
	user?: Resolver<
		ResolversTypes["UserObject"],
		ParentType,
	...
	>;
	voteCheck?: Resolver<
		ResolversTypes["VoteCheckObject"],
		ParentType,
		ContextType,
		RequireFields<QueryVoteCheckArgs, "id">
	>;
};

export type ReplyObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["ReplyObject"] = ResolversParentTypes["ReplyObject"],
> = {
...
export type ReviewObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["ReviewObject"] = ResolversParentTypes["ReviewObject"],
> = {
	...
	replies?: Resolver<
		Array<ResolversTypes["ReplyObject"]>,
		ParentType,
		ContextType
	>;
	updatedAt?: Resolver<ResolversTypes["DateTime"], ParentType, ContextType>;
...
export type ReviewObjectEdgeResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["ReviewObjectEdge"] = ResolversParentTypes["ReviewObjectEdge"],
> = {
	cursor?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type ReviewsConnectionResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["ReviewsConnection"] = ResolversParentTypes["ReviewsConnection"],
> = {
	edges?: Resolver<
		Maybe<Array<ResolversTypes["ReviewObjectEdge"]>>,
		ParentType,
		ContextType
	>;
	nodes?: Resolver<
		Maybe<Array<ResolversTypes["ReviewObject"]>>,
		ParentType,
		ContextType
	>;
	pageInfo?: Resolver<ResolversTypes["PageInfo"], ParentType, ContextType>;
...
> = {
	botStatusChanged?: SubscriptionResolver<
		ResolversTypes["BotObject"],
		"botStatusChanged",
		ParentType,
		ContextType,
		Partial<SubscriptionBotStatusChangedArgs>
	>;
};

export type TagObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["TagObject"] = ResolversParentTypes["TagObject"],
> = {
	bots?: Resolver<
		ResolversTypes["BotsConnection"],
		ParentType,
		ContextType,
		Partial<TagObjectBotsArgs>
	>;
	name?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type TagObjectEdgeResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["TagObjectEdge"] = ResolversParentTypes["TagObjectEdge"],
> = {
	cursor?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
> = {
	edges?: Resolver<
		Maybe<Array<ResolversTypes["TagObjectEdge"]>>,
		ParentType,
		ContextType
	>;
	nodes?: Resolver<
		Maybe<Array<ResolversTypes["TagObject"]>>,
		ParentType,
		ContextType
	>;
	pageInfo?: Resolver<ResolversTypes["PageInfo"], ParentType, ContextType>;
...
export type UserObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["UserObject"] = ResolversParentTypes["UserObject"],
> = {
	avatar?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
	badges?: Resolver<
		Array<ResolversTypes["BadgeObject"]>,
		ParentType,
		ContextType
	>;
...
export type VoteCheckObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["VoteCheckObject"] = ResolversParentTypes["VoteCheckObject"],
> = {
...
export type VoteObjectResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["VoteObject"] = ResolversParentTypes["VoteObject"],
> = {
	bot?: Resolver<ResolversTypes["BotObject"], ParentType, ContextType>;
	botId?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
	expires?: Resolver<ResolversTypes["BigInt"], ParentType, ContextType>;
...
export type VoteBotMutation = {
	__typename?: "Mutation";
	voteBot: { __typename?: "VoteObject"; id: number; expires: any };
};
...
export type RemoveBotMutation = {
	__typename?: "Mutation";
	removeBot: { __typename?: "BotObject"; name: string };
};
...
export type DenyBotMutation = {
	__typename?: "Mutation";
	rejectBot: { __typename?: "BotObject"; name: string; id: string };
};
...
export type ApproveBotMutation = {
	__typename?: "Mutation";
	approveBot: { __typename?: "BotObject"; id: string; name: string };
};
...
export type TagsQuery = {
	...
	tags: {
		...
		nodes?: Array<{
			__typename?: "TagObject";
			name: string;
			bots: { __typename?: "BotsConnection"; totalCount: number };
		}> | null;
	};
};
...
export type PanelBotCountQuery = {
	__typename?: "Query";
	approved: { __typename?: "BotsConnection"; totalCount: number };
	pending: { __typename?: "BotsConnection"; totalCount: number };
	denied: { __typename?: "BotsConnection"; totalCount: number };
};
...
export type BotQuery = {
	...
	getBot: {
		...
		tags: Array<string>;
		votes: number;
		owners: Array<{ __typename?: "UserObject"; id: string; username: string }>;
	};
};
...
export type VoteCheckQuery = {
	__typename?: "Query";
	voteCheck: { __typename?: "VoteCheckObject"; voted: boolean; expires: any };
};

export type FrontBotsQueryVariables = Exact<{ [key: string]: never }>;

export type FrontBotsQuery = {
	__typename?: "Query";
	voted: {
		__typename?: "BotsConnection";
		nodes?: Array<{
...
export const VoteBotDocument = gql`
  ...
  voteBot(id: $id) {
    ...
    `;
export type VoteBotMutationFn = Apollo.MutationFunction<
	VoteBotMutation,
	VoteBotMutationVariables
>;
 ...
 * });
 */
export function useVoteBotMutation(
	...
	return Apollo.useMutation<VoteBotMutation, VoteBotMutationVariables>(
		VoteBotDocument,
		options,
	);
}
...
export type VoteBotMutationOptions = Apollo.BaseMutationOptions<
	VoteBotMutation,
	VoteBotMutationVariables
>;
export const CreateBotDocument = gql`
  ...
  createBot(input: $input) {
    ...
    `;
export type CreateBotMutationFn = Apollo.MutationFunction<
	CreateBotMutation,
...
export function useCreateBotMutation(
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useMutation<CreateBotMutation, CreateBotMutationVariables>(
		CreateBotDocument,
		options,
	);
}
export type CreateBotMutationHookResult = ReturnType<
	typeof useCreateBotMutation
>;
export type CreateBotMutationResult = Apollo.MutationResult<CreateBotMutation>;
export type CreateBotMutationOptions = Apollo.BaseMutationOptions<
	CreateBotMutation,
	CreateBotMutationVariables
>;
export const RemoveBotDocument = gql`
  ...
  removeBot(id: $id) {
    ...
    `;
export type RemoveBotMutationFn = Apollo.MutationFunction<
	RemoveBotMutation,
	RemoveBotMutationVariables
>;
...
export function useRemoveBotMutation(
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useMutation<RemoveBotMutation, RemoveBotMutationVariables>(
		RemoveBotDocument,
		options,
	);
}
export type RemoveBotMutationHookResult = ReturnType<
	typeof useRemoveBotMutation
>;
export type RemoveBotMutationResult = Apollo.MutationResult<RemoveBotMutation>;
export type RemoveBotMutationOptions = Apollo.BaseMutationOptions<
	RemoveBotMutation,
	RemoveBotMutationVariables
>;
export const DenyBotDocument = gql`
  ...
  rejectBot(input: $input) {
    ...
    `;
export type DenyBotMutationFn = Apollo.MutationFunction<
	DenyBotMutation,
	DenyBotMutationVariables
>;
 ...
 * });
 */
export function useDenyBotMutation(
	baseOptions?: Apollo.MutationHookOptions<
		DenyBotMutation,
		DenyBotMutationVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useMutation<DenyBotMutation, DenyBotMutationVariables>(
		DenyBotDocument,
		options,
	);
}
...
export type DenyBotMutationOptions = Apollo.BaseMutationOptions<
	DenyBotMutation,
	DenyBotMutationVariables
>;
export const ApproveBotDocument = gql`
  ...
  approveBot(id: $approveBotId) {
    ...
    `;
export type ApproveBotMutationFn = Apollo.MutationFunction<
	ApproveBotMutation,
	ApproveBotMutationVariables
>;
 ...
 * });
 */
export function useApproveBotMutation(
	baseOptions?: Apollo.MutationHookOptions<
		ApproveBotMutation,
		ApproveBotMutationVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useMutation<ApproveBotMutation, ApproveBotMutationVariables>(
		ApproveBotDocument,
		options,
	);
}
export type ApproveBotMutationHookResult = ReturnType<
	typeof useApproveBotMutation
>;
export type ApproveBotMutationResult =
	Apollo.MutationResult<ApproveBotMutation>;
export type ApproveBotMutationOptions = Apollo.BaseMutationOptions<
	ApproveBotMutation,
	ApproveBotMutationVariables
>;
export const ImportBotDocument = gql`
  ...
  importBot(input: $input) {
    ...
    `;
export type ImportBotMutationFn = Apollo.MutationFunction<
	ImportBotMutation,
	ImportBotMutationVariables
>;
 ...
 * });
 */
export function useImportBotMutation(
	baseOptions?: Apollo.MutationHookOptions<
		ImportBotMutation,
		ImportBotMutationVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useMutation<ImportBotMutation, ImportBotMutationVariables>(
		ImportBotDocument,
		options,
	);
}
export type ImportBotMutationHookResult = ReturnType<
	typeof useImportBotMutation
>;
export type ImportBotMutationResult = Apollo.MutationResult<ImportBotMutation>;
export type ImportBotMutationOptions = Apollo.BaseMutationOptions<
	ImportBotMutation,
	ImportBotMutationVariables
>;
export const TokenDocument = gql`
  ...
  token(input: {token: $token}) {
    ...
    `;
export type TokenMutationFn = Apollo.MutationFunction<
	TokenMutation,
	TokenMutationVariables
>;
...
export function useTokenMutation(
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useMutation<TokenMutation, TokenMutationVariables>(
		TokenDocument,
		options,
	);
}
...
export type TokenMutationOptions = Apollo.BaseMutationOptions<
	TokenMutation,
	TokenMutationVariables
>;
...
export function useRevokeTokenMutation(
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useMutation<RevokeTokenMutation, RevokeTokenMutationVariables>(
		RevokeTokenDocument,
		options,
	);
}
export type RevokeTokenMutationHookResult = ReturnType<
	typeof useRevokeTokenMutation
>;
export type RevokeTokenMutationResult =
	Apollo.MutationResult<RevokeTokenMutation>;
...
export function useSessionSuspenseQuery(
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useSuspenseQuery<SessionQuery, SessionQueryVariables>(
		SessionDocument,
		options,
	);
}
 ...
 * });
 */
export function useUserBotsQuery(
	baseOptions: Apollo.QueryHookOptions<UserBotsQuery, UserBotsQueryVariables> &
		({ variables: UserBotsQueryVariables; skip?: boolean } | { skip: boolean }),
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<UserBotsQuery, UserBotsQueryVariables>(
		UserBotsDocument,
		options,
	);
}
export function useUserBotsLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		UserBotsQuery,
		UserBotsQueryVariables
	>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<UserBotsQuery, UserBotsQueryVariables>(
		UserBotsDocument,
		options,
	);
}
export function useUserBotsSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<
		UserBotsQuery,
		UserBotsQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useSuspenseQuery<UserBotsQuery, UserBotsQueryVariables>(
		UserBotsDocument,
		options,
	);
}
export type UserBotsQueryHookResult = ReturnType<typeof useUserBotsQuery>;
export type UserBotsLazyQueryHookResult = ReturnType<
	typeof useUserBotsLazyQuery
>;
export type UserBotsSuspenseQueryHookResult = ReturnType<
	typeof useUserBotsSuspenseQuery
>;
export type UserBotsQueryResult = Apollo.QueryResult<
	UserBotsQuery,
	UserBotsQueryVariables
>;
...
export function useBotsQuery(
	baseOptions?: Apollo.QueryHookOptions<BotsQuery, BotsQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<BotsQuery, BotsQueryVariables>(BotsDocument, options);
}
export function useBotsLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<BotsQuery, BotsQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<BotsQuery, BotsQueryVariables>(
		BotsDocument,
		options,
	);
}
export function useBotsSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<BotsQuery, BotsQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useSuspenseQuery<BotsQuery, BotsQueryVariables>(
		BotsDocument,
		options,
	);
}
...
export type BotsSuspenseQueryHookResult = ReturnType<
	typeof useBotsSuspenseQuery
>;
 ...
 * });
 */
export function useExploreBotsQuery(
	baseOptions?: Apollo.QueryHookOptions<
		ExploreBotsQuery,
		ExploreBotsQueryVariables
	>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<ExploreBotsQuery, ExploreBotsQueryVariables>(
		ExploreBotsDocument,
		options,
	);
}
export function useExploreBotsLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		ExploreBotsQuery,
		ExploreBotsQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<ExploreBotsQuery, ExploreBotsQueryVariables>(
		ExploreBotsDocument,
		options,
	);
}
export function useExploreBotsSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<
		ExploreBotsQuery,
		ExploreBotsQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useSuspenseQuery<ExploreBotsQuery, ExploreBotsQueryVariables>(
		ExploreBotsDocument,
		options,
	);
}
export type ExploreBotsQueryHookResult = ReturnType<typeof useExploreBotsQuery>;
export type ExploreBotsLazyQueryHookResult = ReturnType<
	typeof useExploreBotsLazyQuery
>;
export type ExploreBotsSuspenseQueryHookResult = ReturnType<
	typeof useExploreBotsSuspenseQuery
>;
export type ExploreBotsQueryResult = Apollo.QueryResult<
	ExploreBotsQuery,
	ExploreBotsQueryVariables
>;
 ...
 * });
 */
export function useBotCountQuery(
	baseOptions?: Apollo.QueryHookOptions<BotCountQuery, BotCountQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<BotCountQuery, BotCountQueryVariables>(
		BotCountDocument,
		options,
	);
}
export function useBotCountLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		BotCountQuery,
		BotCountQueryVariables
	>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<BotCountQuery, BotCountQueryVariables>(
		BotCountDocument,
		options,
	);
}
export function useBotCountSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<
		BotCountQuery,
		BotCountQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useSuspenseQuery<BotCountQuery, BotCountQueryVariables>(
		BotCountDocument,
		options,
	);
}
export type BotCountQueryHookResult = ReturnType<typeof useBotCountQuery>;
export type BotCountLazyQueryHookResult = ReturnType<
	typeof useBotCountLazyQuery
>;
export type BotCountSuspenseQueryHookResult = ReturnType<
	typeof useBotCountSuspenseQuery
>;
export type BotCountQueryResult = Apollo.QueryResult<
	BotCountQuery,
	BotCountQueryVariables
>;
 ...
 * });
 */
export function usePanelBotCountQuery(
	baseOptions?: Apollo.QueryHookOptions<
		PanelBotCountQuery,
		PanelBotCountQueryVariables
	>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<PanelBotCountQuery, PanelBotCountQueryVariables>(
		PanelBotCountDocument,
		options,
	);
}
export function usePanelBotCountLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		PanelBotCountQuery,
		PanelBotCountQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<PanelBotCountQuery, PanelBotCountQueryVariables>(
		PanelBotCountDocument,
		options,
	);
}
export function usePanelBotCountSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<
		PanelBotCountQuery,
		PanelBotCountQueryVariables
	>,
	...
	return Apollo.useSuspenseQuery<
		PanelBotCountQuery,
		PanelBotCountQueryVariables
	>(PanelBotCountDocument, options);
}
export type PanelBotCountQueryHookResult = ReturnType<
	typeof usePanelBotCountQuery
>;
export type PanelBotCountLazyQueryHookResult = ReturnType<
	typeof usePanelBotCountLazyQuery
>;
export type PanelBotCountSuspenseQueryHookResult = ReturnType<
	typeof usePanelBotCountSuspenseQuery
>;
export type PanelBotCountQueryResult = Apollo.QueryResult<
	PanelBotCountQuery,
	PanelBotCountQueryVariables
>;
...
export function useBotQuery(
	baseOptions: Apollo.QueryHookOptions<BotQuery, BotQueryVariables> &
		({ variables: BotQueryVariables; skip?: boolean } | { skip: boolean }),
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<BotQuery, BotQueryVariables>(BotDocument, options);
}
export function useBotLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<BotQuery, BotQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<BotQuery, BotQueryVariables>(BotDocument, options);
}
export function useBotSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<BotQuery, BotQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useSuspenseQuery<BotQuery, BotQueryVariables>(
		BotDocument,
		options,
	);
}
 ...
 * });
 */
export function useVoteCheckQuery(
	baseOptions: Apollo.QueryHookOptions<
		VoteCheckQuery,
		VoteCheckQueryVariables
	> &
		(
			| { variables: VoteCheckQueryVariables; skip?: boolean }
			| { skip: boolean }
		),
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<VoteCheckQuery, VoteCheckQueryVariables>(
		VoteCheckDocument,
		options,
	);
}
export function useVoteCheckLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		VoteCheckQuery,
		VoteCheckQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<VoteCheckQuery, VoteCheckQueryVariables>(
		VoteCheckDocument,
		options,
	);
}
export function useVoteCheckSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<
		VoteCheckQuery,
		VoteCheckQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useSuspenseQuery<VoteCheckQuery, VoteCheckQueryVariables>(
		VoteCheckDocument,
		options,
	);
}
export type VoteCheckQueryHookResult = ReturnType<typeof useVoteCheckQuery>;
export type VoteCheckLazyQueryHookResult = ReturnType<
	typeof useVoteCheckLazyQuery
>;
export type VoteCheckSuspenseQueryHookResult = ReturnType<
	typeof useVoteCheckSuspenseQuery
>;
export type VoteCheckQueryResult = Apollo.QueryResult<
	VoteCheckQuery,
	VoteCheckQueryVariables
>;
 ...
 * });
 */
export function useFrontBotsQuery(
	baseOptions?: Apollo.QueryHookOptions<
		FrontBotsQuery,
		FrontBotsQueryVariables
	>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<FrontBotsQuery, FrontBotsQueryVariables>(
		FrontBotsDocument,
		options,
	);
}
export function useFrontBotsLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		FrontBotsQuery,
		FrontBotsQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<FrontBotsQuery, FrontBotsQueryVariables>(
		FrontBotsDocument,
		options,
	);
}
export function useFrontBotsSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<
		FrontBotsQuery,
		FrontBotsQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useSuspenseQuery<FrontBotsQuery, FrontBotsQueryVariables>(
		FrontBotsDocument,
		options,
	);
}
export type FrontBotsQueryHookResult = ReturnType<typeof useFrontBotsQuery>;
export type FrontBotsLazyQueryHookResult = ReturnType<
	typeof useFrontBotsLazyQuery
>;
export type FrontBotsSuspenseQueryHookResult = ReturnType<
	typeof useFrontBotsSuspenseQuery
>;
export type FrontBotsQueryResult = Apollo.QueryResult<
	FrontBotsQuery,
	FrontBotsQueryVariables
>;
 ...
 * });
 */
export function usePanelBotsQuery(
	baseOptions: Apollo.QueryHookOptions<
		PanelBotsQuery,
		PanelBotsQueryVariables
	> &
		(
			| { variables: PanelBotsQueryVariables; skip?: boolean }
			| { skip: boolean }
		),
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<PanelBotsQuery, PanelBotsQueryVariables>(
		PanelBotsDocument,
		options,
	);
}
export function usePanelBotsLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		PanelBotsQuery,
		PanelBotsQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<PanelBotsQuery, PanelBotsQueryVariables>(
		PanelBotsDocument,
		options,
	);
}
export function usePanelBotsSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<
		PanelBotsQuery,
		PanelBotsQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useSuspenseQuery<PanelBotsQuery, PanelBotsQueryVariables>(
		PanelBotsDocument,
		options,
	);
}
export type PanelBotsQueryHookResult = ReturnType<typeof usePanelBotsQuery>;
export type PanelBotsLazyQueryHookResult = ReturnType<
	typeof usePanelBotsLazyQuery
>;
export type PanelBotsSuspenseQueryHookResult = ReturnType<
	typeof usePanelBotsSuspenseQuery
>;
export type PanelBotsQueryResult = Apollo.QueryResult<
	PanelBotsQuery,
	PanelBotsQueryVariables
>;
